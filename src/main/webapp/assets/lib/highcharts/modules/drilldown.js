(function (g) {
    ...
    l.prototype.getDrilldownBackText = function () {
        ...
        if (a && a.length > 0)
            return a = a[a.length - 1], a.series = a.seriesOptions, z(this.options.lang.drillUpText, a)
    };
    ...
    g.Point.prototype.doDrilldown = function (a) {
        for (var b = this.series.chart, d = b.options.drilldown, c = (d.series || []).length, f; c-- && !f; )
            d.series[c].id === this.drilldown && x(this.drilldown, r) === -1 && (f = d.series[c], r.push(this.drilldown));
    ...
    q(g.Point.prototype, "init", function (a, b, d, c) {
        ...
        if (f.drilldown) {
            if (g.addEvent(f, "click", function () {
                ...
                if (!e.basicStyles)
                    e.basicStyles = g.merge(e.styles);
    ...
    for (s in n)
        n[s].prototype.supportsDrilldown && q(n[s].prototype, "drawTracker",
                o)
})(Highcharts);
