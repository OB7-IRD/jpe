...
(function (j) {
    ...
    p(o.prototype, "getSeriesExtremes", function (a) {
        ...
        if (b && (c = n(this.dataMin, Number.MAX_VALUE), d = n(this.dataMax, Number.MIN_VALUE), i(this.series, function (a, b) {
            if (a.useMapGeometry)
                c = Math.min(c, n(a.minX, c)), d = Math.max(d, n(a.maxX, c)), a.xData = e[b], f = !0
        }), f))
    ...
    q(C.prototype, {defaultColorAxisOptions: {lineWidth: 0, gridLineWidth: 1, tickPixelInterval: 72, startOnTick: !0, endOnTick: !0, offset: 0, marker: {animation: {duration: 50}, color: "gray", width: 0.01}, labels: {overflow: "justify"}, minColor: "#EFEFFF", maxColor: "#003875", tickLength: 5}, init: function (a, b) {
            ...
            i(a.dataClasses, function (a, l) {
                ...
                d.push(a);
                if (!a.color)
                    f.dataClassColor === "category" ? (i = c.options.colors, a.color = i[e++], e === i.length && (e = 0)) : a.color = b.tweenColors(t(f.minColor), t(f.maxColor), g < 2 ? 0.5 : l / (g - 1))
            })
    ...
    D = {pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", dashstyle: "dashStyle"}, pointArrayMap: ["value"], axisTypes: ["xAxis", "yAxis", "colorAxis"], optionalAxis: "colorAxis", trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], getSymbol: s, parallelArrays: ["x", "y", "value"], colorKey: "value", translateColors: function () {
            ...
            i(this.data, function (e) {
                var f = e[d];
                if (f = f === null ? b : c && f !== void 0 ? c.toColor(f, e) : e.color || a.color)
                    e.color = f
            })
        }};
            ...
            if (n(b.enableButtons, b.enabled) && !a.renderer.forExport)
                for (d in c)
                    if (c.hasOwnProperty(d))
                        f = m(b.buttonOptions, c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text,
    ...
    p(v.prototype, "init",
            function (a, b, c) {
                a.call(this, b, c);
                if (n(c.mapNavigation.enableTouchZoom, c.mapNavigation.enabled))
        ...
        pointClass: v, supportsDrilldown: !0, getExtremesFromAll: !0, useMapGeometry: !0, forceDL: !0, getBox: function (a) {
            ...
            i(a || [], function (a) {
                if (a.path) {
                    ...
                    if (!a._foundBox) {
                        for (; i--; )
                            typeof h[i] === "number" && !isNaN(h[i]) && (l ? (m = Math.max(m, h[i]), o = Math.min(o, h[i])) : (q = Math.max(q, h[i]), p = Math.min(p, h[i])), l = !l);
            ...
            if (k) {
                ...
                if (l && l.options.minRange === void 0)
                    l.minRange = Math.min(5 * g, (this.maxY - this.minY) / 5, l.minRange || b)
            }
            ...
            if (d) {
                ...
                for (k = 0; k <
                        d.length; k++)
                    h = d[k], l = h.properties, h._i = k, e[0] && l && l[e[0]] && (h[e[0]] = l[e[0]]), this.mapMap[h[e[0]]] = h;
            ...
            i(a.data, function (e) {
                ...
                if (d)
                    e.shapeType = "path", e.shapeArgs = {d: a.translatePath(e.path), "vector-effect": "non-scaling-stroke"}
            });
            a.translateColors()
        }, drawPoints: function () {
            ...
            i(a, function (a, b) {
                if (b = a.dataLabel) {
                    if (b.oldOpacity !== b.newOpacity)
                        b[b.isOld ? "animate" : "attr"](q({opacity: b.newOpacity},
                                b.alignAttr));
                    b.isOld = !0
                }
            })
            ...
            if (!a)
                a = Math.min(d.width / b.width, d.height / b.height), c.shapeArgs = {scaleX: a, scaleY: a, translateX: d.x, translateY: d.y}, i(this.points, function (a) {
    ...
    j.geojson = function (a, b, c) {
        ...
        if (c)
            c.chart.mapCredits = '<a href="http://www.highcharts.com">Highcharts</a> © <a href="' + a.copyrightUrl +
                    '">' + a.copyrightShort + "</a>";
        return d
    };
    p(z.prototype, "showCredits", function (a, b) {
        if (x.credits.text === this.options.credits.text && this.mapCredits)
