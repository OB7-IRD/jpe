...
if ($.fn.dataTable.Api) {
    ...
    $.fn.dataTable.ext.renderer.pageButton.bootstrap = function (e, l, k, j, i, d) {
        var h = new $.fn.dataTable.Api(e);
        var f = e.oClasses;
        ...
        var g = function (n, r) {
            ...
            var s = function (t) {
                t.preventDefault();
                if (t.data.action !== "ellipsis") {
                    h.page(t.data.action).draw(false)
                }
            };
            for (p = 0, m = r.length; p < m; p++) {
                ...
                if ($.isArray(o)) {
                    ...
                    if (b) {
                        q = $("<li>", {"class": f.sPageButton + " " + a, "aria-controls": e.sTableId, tabindex: e.iTabIndex, id: k === 0 && typeof o === "string" ? e.sTableId + "_" + o : null}).append($("<a>", {href: "#"}).html(b)).appendTo(n);
